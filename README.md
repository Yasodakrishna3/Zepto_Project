...
## 📁 Dataset Overview
The dataset was sourced from [Kaggle](https://www.kaggle.com/datasets/palvinder2006/zepto-inventory-dataset) and was originally scraped from Zepto’s official product listings. It mimics what you’d typically encounter in a real-world e-commerce inventory system.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Yasodakrishna3/Zepto_Project.git
   cd Zepto_Project
   ```
...
💼 LinkedIn: [Pittu Yasodakrishna](https://www.linkedin.com/in/pittuyasodakrishna))
